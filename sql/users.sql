...
CREATE TABLE `users`  (
  ...
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '邮箱(可以为空, 由用户自己添加邮箱并激活, 未激活邮箱不能使用邮箱登录)',
  `emailActive` tinyint(1) UNSIGNED ZEROFILL NOT NULL DEFAULT 0 COMMENT '邮箱是否激活',
  `status` enum('-1','0','1') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '1' COMMENT '状态(-1:删除,0:冻结,1正常)',
